...
public class FieldDecl extends FENode
{
     ...
     */
    /** Yousun Ko:
     * @param   states  List of boolean indicating whether the var keeps
     *                  state value over iteration or not.
     */
    public FieldDecl(FEContext context, List<Type> types, List<String> names,
                     List<Expression> inits, List<Boolean> states)
    {
        super(context);
        ...
        this.states = new ArrayList<Boolean>(states);
    }
    ...
    {
        super(context);
        List<Boolean> initStates = new ArrayList<Boolean>();
        ...
        this.names = new ArrayList<String>(names);
        this.inits = new ArrayList<Expression>(inits);
        this.states = new ArrayList<Boolean>(initStates);
    }
    ...
    public FieldDecl(FEContext context, Type type, String name,
                     Expression init)
    {
        this(context, type, name, init, true);
    }
 
    public FieldDecl(FEContext context, Type type, String name,
                     Expression init, boolean isState)
    {
        this(context,
             Collections.singletonList(type),
             Collections.singletonList(name),
             Collections.singletonList(init),
             Collections.singletonList(isState));
    }
