...
public class FeedbackLoop extends Stream
{
    ...
    // Yousun Ko: store uncontaminated enqueued values
    List<Object> enqueued_copy = new java.util.ArrayList<Object>();
    int delay;
    Stream body, loop;
    ...
    // Yousun Ko: return enqueued values
    public List<Object> getEnqueued() {return enqueued_copy; }
                        ...
                        if (type == Integer.TYPE)
                            {
                                ...
                                // Yousun Ko: backup the enqueued value
                                enqueued_copy.add(value.intValue());
                            } else
                                if (type == Short.TYPE)
                                    {
                                        ...
                                        // Yousun Ko: backup the enqueued value
                                        enqueued_copy.add(value.shortValue());
                                    } else
                                        if (type == Character.TYPE)
                                            {
                                                ...
                                                // Yousun Ko: backup the enqueued value
                                                enqueued_copy.add(value.charValue());
                                            } else
                                                if (type == Float.TYPE)
                                                    {
                                                        ...
                                                        // Yousun Ko: backup the enqueued value
                                                        enqueued_copy.add(value.floatValue());
                                                    } else
                                                        {
                                                            // this is essentially a default
                                                            // if this isn't what you want, you should implement
