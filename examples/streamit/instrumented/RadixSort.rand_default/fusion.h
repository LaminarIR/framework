...
#define __BUF_SIZE_MASK_2_3 (pow2ceil(16+0)-1)

#define __BUF_SIZE_MASK_3_4 (pow2ceil(16+0)-1)

#define __BUF_SIZE_MASK_4_5 (pow2ceil(16+0)-1)

#define __BUF_SIZE_MASK_5_6 (pow2ceil(16+0)-1)

#define __BUF_SIZE_MASK_6_7 (pow2ceil(16+0)-1)

#define __BUF_SIZE_MASK_7_8 (pow2ceil(16+0)-1)

#define __BUF_SIZE_MASK_8_9 (pow2ceil(16+0)-1)

#define __BUF_SIZE_MASK_9_10 (pow2ceil(16+0)-1)

#define __BUF_SIZE_MASK_10_11 (pow2ceil(16+0)-1)

#define __BUF_SIZE_MASK_11_12 (pow2ceil(16+0)-1)
