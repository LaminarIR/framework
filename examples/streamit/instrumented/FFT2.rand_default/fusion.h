...
#define __BUF_SIZE_MASK_1_2 (pow2ceil(32+0)-1)

#define __BUF_SIZE_MASK_1_11 (pow2ceil(32+0)-1)

#define __BUF_SIZE_MASK_2_3 (pow2ceil(32+0)-1)
...
#define __BUF_SIZE_MASK_6_7 (pow2ceil(32+0)-1)

#define __BUF_SIZE_MASK_7_8 (pow2ceil(32+0)-1)

#define __BUF_SIZE_MASK_8_9 (pow2ceil(32+0)-1)
...
#define __BUF_SIZE_MASK_13_14 (pow2ceil(32+0)-1)
...
#define __BUF_SIZE_MASK_17_9 (pow2ceil(32+0)-1)
